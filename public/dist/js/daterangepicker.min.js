!(function (t, a) {
    ...
    var i = function (t, e, a) {
        ...
        if (
            ...
            var l = R(this.element).val(),
                h = l.split(this.locale.separator);
            (n = r = null),
                2 == h.length
                    ? ((n = j(h[0], this.locale.format)),
                      (r = j(h[1], this.locale.format)))
                    : this.singleDatePicker &&
                      "" !== l &&
                      ((n = j(l, this.locale.format)),
                      (r = j(l, this.locale.format))),
                null !== n &&
                    null !== r &&
            ...
            for (o in e.ranges) {
                (n =
                    "string" == typeof e.ranges[o][0]
                        ? j(e.ranges[o][0], this.locale.format)
                        : j(e.ranges[o][0])),
                    (r =
                        "string" == typeof e.ranges[o][1]
                            ? j(e.ranges[o][1], this.locale.format)
                            : j(e.ranges[o][1])),
                    this.minDate &&
    ...
    return (
        (i.prototype = {
            ...
            setStartDate: function (t) {
                "string" == typeof t &&
                    (this.startDate = j(t, this.locale.format)),
            ...
            setEndDate: function (t) {
                "string" == typeof t &&
                    (this.endDate = j(t, this.locale.format)),
            ...
            renderCalendar: function (t) {
                var e,
                    ...
                    l = j([i, a, 1]),
                    h = j([i, a, o]),
                    c = j(l).subtract(1, "month").month(),
                    d = j(l).subtract(1, "month").year(),
                    m = j([d, c]).daysInMonth(),
                    f = l.day();
                ...
                for (
                    var D = j([d, c, u, 12, n, r]), g = ((p = 0), 0), y = 0;
                    p < 42;
                    p++, g++, D = j(D).add(24, "hour")
                )
                    0 < p && g % 7 == 0 && ((g = 0), y++),
                ...
                if (
                    ((v += '<th colspan="5" class="month">' + C + "</th>"),
                    ...
                    for (g = 0; g < 7; g++) {
                        ...
                        e[y][g].isSame(new Date(), "day") && E.push("today"),
                            ...
                            null != this.endDate &&
                                ...
                                e[y][g] < this.endDate &&
                                E.push("in-range");
                        var W = this.isCustomDate(e[y][g]);
                        !1 !== W &&
                            ("string" == typeof W
                                ? E.push(W)
                                : Array.prototype.push.apply(E, W));
                        var O = "",
                            H = !1;
                        for (p = 0; p < E.length; p++)
                            (O += E[p] + " "), "disabled" == E[p] && (H = !0);
                        H || (O += "available"),
                            (v +=
                                '<td class="' +
                                O.replace(/^\s+|\s+$/g, "") +
            ...
            move: function () {
                ...
                if (
                    ...
                    var n;
                    (n = this.element.offset().left - e.left) + i >
                    R(window).width()
                        ? this.container.css({ top: t, left: "auto", right: 0 })
                        : this.container.css({
                              top: t,
            ...
            timeChanged: function (t) {
                ...
                isNaN(s) &&
                    (s = parseInt(
                        e.find(".minuteselect option:last").val(),
                        10
                    ));
                ...
                if (a) {
                    ...
                    l.hour(i), l.minute(s), l.second(n), this.setEndDate(l);
                }
                this.updateCalendars(),
                    this.updateFormInputs(),
                    this.renderTimePicker("left"),
