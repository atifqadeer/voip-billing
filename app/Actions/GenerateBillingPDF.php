...
use Carbon\Carbon;
use TCPDF;
use App\CustomTCPDF; // Import the custom TCPDF class
...
class GenerateBillingPDF implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $monthName = Carbon::create()->month($billing->month)->format('F');
            $pdfName = 'TelephoneBill_' . $monthName . '_' . $billing->year . '_' . strtoupper($sanitizedClientName) . '_' . $billing->uuid . '.pdf';
